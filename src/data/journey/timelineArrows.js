        ...
        projects: [
            {
                ...
                chall: `
                    ...
                    more modular before adding server‑side functionality. I also struggled with 
            ...
            },
            {
                ...
                chall: `
                    ...
                    and online sources which enhanced my thinking skills. Structuring 
                    questions into categories and levels, enforcing progression rules, and 
                    tracking user state (time, score, and progress) required careful logic and 
                    debugging. I also struggled with organizing the data model for questions and 
        ...
        projects: [
            {
                ...
                info: `
                    ...
                    full implementation. For this project, I wanted to go beyond building something 
                    for the sake of 
                    ...
                    to buy that system. Even before I knew much about software, I often wondered 
                    why there wasn’t 
                    a simple, accessible tool to help them manage their business more effectively 
                    and for free.
                    That observation became the foundation of my project. What started as a basic 
                    ...
                    with insights that could drive growth and sustainability. This project taught 
                ...
                chall: `
                    ...
                    diagrams and technical reports. Managing this level of rigor while continuing to 
                    ...
                    their businesses. Balancing ambition with practicality was difficult, but it 
                    pushed me to think strategically about scalability, maintainability, and long‑term 
                    value.
                `,
            },
            {
                ...
                info: `
                    ...
                    further. I began exploring modern web technologies, frameworks, and development 
                    ...
                    just exercises. Since I was approaching graduation, I decided to channel this 
                    learning into building my own portfolio — a project that would not only showcase 
                    my technical abilities but also reflect my journey, growth, and identity as a 
                    developer. 
                    ...
                    scalability, and how to communicate my work effectively to others. In many ways, 
                    it marked the transition from being a student who builds projects for courses to 
                    a developer who builds projects for real‑world impact.
                `,
                chall: `
                    ...
                    visually appealing layout was both difficult and time‑consuming. I didn’t 
                    initially know what a portfolio should contain, which led me to spend a lot 
                    ...
                    and experimentation. Balancing the technical learning curve with the need to 
        ...
        projects: [
            {
                ...
                info: `
                    ...
                    while practicing new technologies. As part of my roadmap, I committed to 
                    building 2–3 projects after learning each new tech stack. Through 
                    research, I realized that an e‑commerce website would be one of the most 
                    effective ways to strengthen my skills, since it touches on complex 
                    features like product listings, shopping carts, and user flows. 
                    ...
                    professional mockups into clean, maintainable code. The project became 
                ...
                chall: `
                    ...
                    was initially overwhelming. Over time, I became more comfortable, but this 
                    ...
                    every project as if it were going to be scaled or refactored later. Beyond 
                    ...
                    However, the Figma design I chose was not what I expected. It was missing core 
