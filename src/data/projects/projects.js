...
export const PROJECTS = [
...

    {
        ...
        description: `A CLI-based tool that automates documentation for my personal portfolio projects. It collects project data via prompts, injects it into my structured project.js file, and generates polished README files for individual or all projects, including automatic ranking and consistent formatting.`,
