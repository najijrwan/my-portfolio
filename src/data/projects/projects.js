...
export const PROJECTS = [
...

    {
        ...
        techStack: [TECHS_BY_TECH.nodejs, TECHS_BY_TECH.vscode, TECHS_BY_TECH.git],
        keyFeatures: ['Interactive CLI workflow using prompts to dynamically collect project data', 'Automated generation of structured README files with consistent formatting and sections', 'Custom formatting engine to handle nested objects, arrays, and clean output rendering', 'Separation of concerns between data collection, formatting logic, and file generation', 'Scalable architecture allowing easy extension of sections, templates, and formatting rules', 'Improves developer productivity by eliminating repetitive README writing tasks'],
        futureImprovements: ['Add multiple README templates (minimal, detailed, portfolio-focused)', 'Support Markdown preview before file generation', 'Export configurations for reuse across multiple projects', 'Add support for badges, images, and dynamic sections (e.g., shields.io)', 'Build a web-based UI version for non-CLI users'],
        credits: ['Built and designed بالكامل independently', 'Inspired by the need for structured documentation and reusable workflows'],
        notes: ['This project reflects a shift toward building developer tools rather than just applications.', 'Focus was placed on code structure, scalability, and maintainability rather than UI.', 'Serves as a foundation for future tooling and automation-focused projects.'],
    },
]