...
const About = () => {
  return (
    <article className="about sm:mb-[20px]">
      ...
      <section className="mb-9">
        <ul className="grid grid-cols-1 gap-5">
          <li className={ele1}>
            <div className="mb-2.5 sm:mb-0 sm:mt-[5px]">
      ...
      <div className="mb-4">
        ...
        sm:gap-[50px] sm:my-0 sm:mx-[-30px] sm:p-[45px] sm:scroll-px-[45px]">
          <li className="min-w-[50%] snap-start bg-white/10 rounded-4xl clients-item"><img src="src/assets/react.png" alt="react image" /></li>
          <li className="min-w-[50%] snap-start bg-white/10 rounded-4xl clients-item"><img src="src/assets/java.png" alt="java image" /></li>
          <li className="min-w-[50%] snap-start bg-white/10 rounded-4xl clients-item"><img src="src/assets/js-img.webp" alt="javascript image" /></li>
          <li className="min-w-[50%] snap-start bg-white/10 rounded-4xl clients-item"><img src="src/assets/tailwind-css.png" alt="tailwind image" /></li>
          <li className="min-w-[50%] snap-start bg-[rgb(38,70,124)] rounded-4xl clients-item"><img src="src/assets/php.png" alt="php image" /></li>
          <li className="min-w-[50%] snap-start bg-white/10 rounded-4xl clients-item"><img src="src/assets/python.png" alt="python image" /></li>
          <li className="min-w-[50%] snap-start bg-white/10 rounded-4xl clients-item"><img src="src/assets/csharp.png" alt="c sharp image" /></li>
        </ul>
      </div>
    </article>
  );
